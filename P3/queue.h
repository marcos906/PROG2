 ...
 * @date 16 Mar 2022
 * @brief Public interface for a queue implementation based on a list.
 */
 ...
 * queue. A reference to the element is added to the queue container. 
 * Time complexity: O(1).
 * 
 * @param q A pointer to the queue.
 ...
 * a queue. A reference to the element is returned. 
 * Time complexity: O(1).
 *
 ...
 * -1 if it is called with a NULL pointer. Time complexity: O(1).
 *
 * @param q A pointer to the queue.
 *
